...
class Device {
    ...
    */
    static new() {
        var ret = wasm.device_new();
        return Device.__wrap(ret);
    }
    /**
    */
    render() {
        wasm.device_render(this.ptr);
    }
    /**
    * @param {number} width
    * @param {number} height
    */
    resize(width, height) {
        wasm.device_resize(this.ptr, width, height);
    }
    /**
    * @param {number} code
    */
    handle_key_input(code) {
        wasm.device_handle_key_input(this.ptr, code);
    }
}
__exports.Device = Device;
